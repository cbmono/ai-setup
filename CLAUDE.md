...
- `.claude/settings.json` — checked-in, team-shared permissions baseline plus the small set of universally-safe hooks that no-op when not applicable (currently: format-on-write).
