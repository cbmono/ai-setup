...
## Reference
* Awaiting you — `AWAITING.md` **if present**: what needs a human decision (approve · answer · merge · unblock · close), rewritten each `/pm-loop` tick. Absent means the queue is turned off
...
## Objectives
<!-- * [<objective title>](/objectives/<slug>.md) - <one line> -->

## Projects
<!-- * [<project title>](/projects/<slug>/project.md) - target: `<org>/<repo>` -->
