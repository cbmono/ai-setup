...
model:                                # optional: override model routing — a tier (light|standard|deep) or a raw alias (haiku|sonnet|opus). PM honors it verbatim (see instance.config.json models/roleTiers).
